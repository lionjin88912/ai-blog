...
FAQ 區塊在文章末尾的命名:**用該人格的口吻命名**(林太用「林太的小叮嚀」,王老闆可能用「王老闆的呷飯心法」)。命名規則寫在 persona.md 裡,從那邊讀(具體位置:「文章架構偏好」段,例如 mrs-lin 寫了「尾段必含:『林太的小叮嚀(FAQ)』」)。沒寫則 fallback 為「<display_name>的問與答」。
