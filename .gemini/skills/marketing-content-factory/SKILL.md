...
範例:`日月潭兩天一夜慢旅全攻略｜林太的湖畔散策、私房茶席與熟齡住宿心法 | 林太的慢活旅行誌`
...
```
**Step 4 / H3 小標 — 先發散**
我把整篇能講的點都列出來,涵蓋「開場切入、景點(3-4 個)、熟齡視角、節奏建議」幾個面向。等你點頭,Step 5 再去歸納成章節 ──

1. 從窗邊茶香說起 — 為什麼想去日月潭
2. 向山遊客中心的清晨光線
3. 湖畔散策:伊達邵到水社的私房節奏
4. 茶廠裡的時光感:阿薩姆紅茶的故事
5. 給熟齡旅人的住宿建議:湖景房怎麼挑、價位帶怎麼抓
6. 兩天行程的呼吸節奏:該慢哪段、該快哪段
...
```
**Step 5 / H2 大綱 — 把剛才的 H3 歸納成章節**
我用「時間順序」分組(出發前 → 旅程中 → 收尾),這樣讀者跟著文章節奏很順 ──

## 一、出發前的心情(對應剛剛第 1 個小標)
## 二、湖畔散策的私房節奏(對應剛剛第 2、3、4 個小標)
## 三、慢旅尾聲的安排(對應剛剛第 5、6 個小標)
...
10a 階段 `wp_poster.py` 印 `✅ 成功` 時,**腳本內部已 webbrowser.open(草稿連結)**,Gemini 這邊不用再做。
...
> ✅ 寫好囉!**我已經幫你開好 WordPress 後台分頁了** 👀
>
> 📄 標題:`<H1>`
> 🔗 草稿連結:`<WordPress 後台編輯連結>`(若分頁沒自動跳,複製這個連結)
> 🖼️ 用了 X 張圖、寫了約 X 字
> 🎯 焦點關鍵字:`<keywords[0]>`
>
